      ...
      >
        <div className="md:bg-black/40 bg-black/60 text-white h-[100%] flex items-center w-[100%] pl-12">
          <div className="flex flex-col md:w-[50%] items-start gap-5">
            ...
            <a
              href="/#services"
              className="bg-[#0F1D33] hover:scale-105 transition-all ease-in-out duration-500 cursor-pointer ibm-500  flex gap-3 items-center uppercase text-[14px] rounded-[50px]  text-[#E1C598]  px-5 py-3"
            >
